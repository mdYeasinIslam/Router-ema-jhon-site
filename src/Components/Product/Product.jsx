...
const Product = ({ product, setHandelar }) => {
    const { id, name, price, seller, shipping, ratings, img } = product

    const addToLocal = () => {
        addToCart(id, price, shipping,img)
        setHandelar()
    }
    return (
        <div className="card w-72 h-[500px] p-2 border-2 border-violet-500 bg-base-100 shadow-xl">
            ...
            <div className="card-body py-0 pl-0">
                ...
                <div className="card-actions ">
                    <button onClick={() => addToLocal()} className="btn btn-primary w-full ">Buy Now <ShoppingCartIcon className=" ml-2 h-6 w-6"></ShoppingCartIcon></button>
